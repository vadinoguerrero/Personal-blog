const posts = [
  {
    id: '1',
    title: 'Learning to be myself',
    date: '22/5/26',
    description:
      "I don't have to pretend I'm someone I'm not to fit in, make friends or advance with girls, I have to be myself enough to attract the right people who will appreciate it. En resumen, hay gente que es para vos y gente que no, y no es porque haya nada mal en vos, sino que es así porque sí y listo",
  },
  {
    id: '2',
    title: null,
  ...
  },
  {
    ...
    date: '31/7/22',
    description:
      'Reírse es liberar tensión al presenciar cosas que burlan la seriedad de la vida',
  },
  {
    id: '5',
    title: null,
    date: '12/12/21',
    description: 'La felicidad es proporcional a la esperanza y la gratitud',
  },
];
